  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Sidebar */}
        <div className={`transition-all duration-300 ease-in-out bg-[#0f0f0f] text-white overflow-y-auto ${isSidebarOpen ? 'w-64' : 'w-16'}`}>
          <div className="flex items-center justify-between px-4 py-4 border-b border-gray-700">
            <h1 className={`text-lg font-semibold ${isSidebarOpen ? 'block' : 'hidden'}`}>Gemini Bot</h1>
        ...
        <div className="flex-1 flex flex-col mx-10 overflow-hidden relative">
          ...
          {/* Chat & Input */}
          <div className="flex-1 flex flex-col justify-between overflow-y-scroll bg-[#0f0f0f] p-4 mb-22 rounded-t-2xl">
            {/* Chat Box */}
            <div ref={chatRef} className="flex-1 p-4 space-y-4 bg-[#1a1a1a] rounded-xl field-sizing-fixed mb-4">
